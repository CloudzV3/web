        ...
        <ul class="nav_list">
            ...
            <li>
                <a href="analisis.php">
                    ...
                    <span class="links_name">Analíticos</span>
                </a>
                <span class="tooltip">Analíticos</span>
            </li>
            <li>
                <a href="personal.php">
            ...
            <li>
                <a href="#">
                    <i class='bx bx-cog'></i>
                    <span class="links_name">Registrar user</span>
                </a>
                <span class="tooltip">Registrar user</span>
            </li>
            <li>
                <a href="">
